// FILE: apps/storefront/src/themes/basit/components/product-cart/ProductCartRuntime.tsx
...
export default function ProductCartRuntime({ currencies = null }: Props) {
  ...
  useEffect(() => {
    const onAddToCart = async (event: Event) => {
      ...
      const enhancedAddNoticeEnabled =
        item.enable_add_product_toast !== false &&
        item.enableAddProductToast !== false;
