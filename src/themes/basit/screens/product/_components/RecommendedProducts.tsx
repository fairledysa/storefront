// FILE: apps/storefront/src/themes/basit/screens/product/_components/RecommendedProducts.tsx

"use client";

import type { SeoUrlMode } from "@/data/store/settings";
import { buildProductHref } from "@/lib/seo/build-store-href";
import ProductsSlider from "../../home/_components/ProductsSlider";
...
export default function RecommendedProducts({
  ...
  return (
    <div className="mk-drecommended mk-drecommended--slider" dir="rtl">
      <ProductsSlider
        title={title}
        viewAllText=""
        viewAllHref="#"
