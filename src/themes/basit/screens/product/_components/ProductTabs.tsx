// FILE: apps/storefront/src/themes/basit/screens/product/_components/ProductTabs.tsx
"use client";
...
export default function ProductTabs({
  ...
  const { short, cut } = useMemo(() => {
    return clampText(descPlain, 240);
  }, [descPlain]);
  ...
  if (mode === "details_cards") {
    ...
    return (
      <div dir="rtl" className="mk-ptabs mk-ptabs--cards">
        {hasSpecs ? (
          <section className="mk-ptabs-detailsPlain" aria-label="تفاصيل المنتج">
            <div className="mk-ptabs-detailsPlain__heading">
              <h2 className="mk-ptabs-detailsPlain__title">التفاصيل</h2>
              {specsMeta ? (
                <span className="mk-ptabs-detailsPlain__meta">{specsMeta}</span>
              ) : null}
            </div>

            <div className="mk-ptabs-detailsPlain__line" aria-hidden="true" />
        ...
        {hasDescription ? (
          <section className="mk-ptabs-descriptionClean" aria-label="وصف المنتج">
            <div className="mk-ptabs-descriptionClean__heading">
              <h2 className="mk-ptabs-descriptionClean__title">وصف المنتج</h2>
            </div>
            <div className="mk-ptabs-descriptionClean__line" aria-hidden="true" />
            ...
            {canCollapse ? (
              <button
                ...
                className="mk-ptabs-descriptionClean__more"
              >
