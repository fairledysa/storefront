// FILE: apps/storefront/src/themes/basit/screens/maintenance/render-maintenance-page.tsx

import "server-only";

import { getSeoUrlMode } from "@/data/store/settings";
import { getMalakBootstrap } from "@/themes/basit/bootstrap/get-malak-bootstrap";
import type {
  MalakBootstrap,
  MalakBootstrapHelpItem,
} from "@/themes/basit/bootstrap/types";
