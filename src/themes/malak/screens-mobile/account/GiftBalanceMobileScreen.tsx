...
function money(value:number,currency:string){return `${new Intl.NumberFormat("ar-SA",{maximumFractionDigits:2}).format(value)} ${currency}`}
function date(value:string|null){if(!value)return "";const d=new Date(value);if(Number.isNaN(d.getTime()))return "";return new Intl.DateTimeFormat("ar-SA",{day:"numeric",month:"short",year:"numeric"}).format(d)}
