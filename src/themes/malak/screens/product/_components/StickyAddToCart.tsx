// FILE: apps/storefront/src/themes/malak/screens/product/_components/StickyAddToCart.tsx
"use client";
...
export default function StickyAddToCart({
  ...
  return (
    <div dir="rtl" className="mk-pcart">
      {hasExtras ? (
        <div className="mk-pcart-extras">
          ...
          {allowFileUpload ? (
            <div className="mk-pcart-extras__hint">
              مسموح حتى 4 صور فقط — بصيغة JPG / PNG / WEBP — الحد الأقصى لكل
              صورة 7MB
            </div>
          ) : null}
      ...
      <div className="mk-pcart-actions">
        ...
        >
          ...
          {typeof price === "number" ? (
            <span className="mk-pcart-submit__price">
